...
public class DataHandlers {
	...
	public static void getUserCurrentGroupInfomation(String gid) {
		...
		// httpUtils.send(HttpMethod.POST, API.GROUP_GET, params,
		// responseHandlers.getGroupInfomationCallBack);
	}
	...
	public static void getUserCurrentGroupMembers(String gid, String type) {
		...
		// responseHandlers.getCurrentNewGroupMembersCallBack;
		...
		// httpUtils.send(HttpMethod.POST, API.GROUP_GETALLMEMBERS, params,
		// callBack);
	}
	...
	public static void getUserInfomation() {
		...
		// httpUtils.send(HttpMethod.POST, API.ACCOUNT_GET, params,
		// responseHandlers.getUserInfomation);
	}
