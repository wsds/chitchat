...
public class MyListView extends ListView implements OnScrollListener {
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.id.mylistview_header_content);
		mHeaderTimeView = (TextView) mHeaderView.findViewById(R.id.mylistview_header_time);
	...
	private void invokeOnScrolling() {
		if (mScrollListener instanceof MyOnScrollListener) {
			MyOnScrollListener l = (MyOnScrollListener) mScrollListener;
			l.myOnScrolling(this);
		}
	}
	...
	public interface MyOnScrollListener extends OnScrollListener {
		public void myOnScrolling(View view);
	}
	...
	public class MyListViewHeader extends LinearLayout {
		...
		private void initView(Context context) {
			...
			mArrowImageView = (ImageView) findViewById(R.id.mylistview_header_arrow);
