...
//                    if ((contentBox.offsetHeight / mainBox.offsetHeight) > 1 || mainBox =="chatFrame") {
                        element.style.top = flag + "px";
                        contentBox.style.top = -flag * (contentBox.offsetHeight / mainBox.offsetHeight) + "px";
//                        alert(flag + "--" + -flag * (contentBox.offsetHeight / mainBox.offsetHeight) + "--" + contentBox.offsetHeight + "--" + mainBox.offsetHeight);
//                    }
                });
            }
        },
